  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   <div class="container">
    <ul class="nav navbar-nav">
      ...
      <?php if(Session::get('loggedIn') == true){ echo '<li><a href="'.$_SERVER['DOCUMENT_ROOT'].'/views/klantPaneel/index.php">Klanten Paneel</a></li>'; echo '<li><a href="../account">Mijn Account</a></li>'; }?>
    </ul>
    </div>
  </div><!-- /.navbar-collapse -->
</nav>
