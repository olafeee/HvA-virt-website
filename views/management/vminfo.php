...
if(strcmp($vmResponse[0]['state'],'Running') == 0) 
{
    ...
    $onOff .= '<a type="button"  class="btn btn-primary newWindow" href="/management/console/' . $vmResponse[0]['id'] . '" style="margin-bottom:5px; width:125px;" onclick="window.open(this.href, "Console", "width=735, height=540, left=24, top=24, scrollbars, resizable"); return false;">View Console</a> ';
