...
<div id="popupdestroy" class="popupdiv" style="display:none;">
  <p>Warning!</p><br />
</div>
...
<div class="row">
  <div class="col-md-12" role="main">
    ...
    <button type="button" class="btn btn-danger popupCmdButton" id="destroy" style="margin-bottom:5px; min-width:125px;"><span class="glyphicon glyphicon-exclamation-sign"></span>  Destroy System</button>
